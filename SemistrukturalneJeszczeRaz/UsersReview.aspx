<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UsersReview.aspx.cs" Inherits="UsersReview" EnableEventValidation="false"%>
    ...
    <div class="grid">
        <asp:GridView ID="GridView1" runat="server" CssClass="myGridview" RowStyle-CssClass="rows" HeaderStyle-CssClass="gridHeader" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowCommand="GridView1_RowCommand">
            <Columns>
                ...
                <asp:ButtonField ButtonType="Image" ImageUrl="~/SzczegolyButton.png" Text="Szczegóły"  CommandName="Szczegoly" />
            </Columns>
