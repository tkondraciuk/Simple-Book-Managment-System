<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="NewBook.aspx.cs" Inherits="NewBook" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content" Runat="Server">
    <div class="bigTitle">Dodaj książkę</div>
    <div class="formAdd">
        ...
        <div>Ilość: <asp:TextBox ID="ilosc" runat="server" CssClass="textbox" Text="1"></asp:TextBox></div>
